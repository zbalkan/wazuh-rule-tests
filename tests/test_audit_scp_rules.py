...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            '92601',
            6,
            id='executed_python_script_from_tmp_folder_1',
        ),
        pytest.param(
            ...
            '92601',
            6,
            id='executed_python_script_from_tmp_folder_2',
        ),
        pytest.param(
            ...
            '92602',
            12,
            id='suspicious_python_script_matches_impacket_signature_possible_use_of_stolen_credentials_or_pass_the_hash_attack',
        ),
        pytest.param(
            ...
            '92603',
            6,
            id='scp_used_to_copy_a_file_over_ssh',
        ),
        pytest.param(
            ...
            '92604',
            6,
            id='processes_running_for_all_users_were_queried_with_ps_command',
        ),
        pytest.param(
            ...
            '92605',
            6,
            id='executed_recursive_query_of_all_files_using_ls_command',
        ),
    ],
)
def test_rule_match(
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            '92601',
            6,
            id='executed_python_script_from_tmp_folder_3',
        ),
    ],
)
