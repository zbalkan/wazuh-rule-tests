...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            r"""{"integration":"aws","aws":{"log_info":{"aws_account_alias":"","log_file":"access_logs/2021-04-29-09-41-37-6CFDED3B1BCCDEB1","s3bucket":"wazuh-aws-wodle"},"bucket_owner":"3ab1235e25ea9e94ff9b7e4e379ba6b0c872cd36c096e1ac8cce7df433b47101","bucket":"wazuh-cloudtrail","time":"29/Apr/2021:08:57:58 +0000","remote_ip":"213.194.148.169","requester":"arn:aws:iam::166157441623:user/carlos.ridao","request_id":"M5XS2MGJ6FEA5VTJ","operation":"REST.DELETE.BUCKETVERSIONS","key":"-","request_uri":"GET /?versions&max-keys=1&encoding-type=url HTTP/1.1","http_status":"200","error_code":"-","bytes_sent":"839","object_sent":"-","total_time":"54","turn_around_time":"53","referer":"-","user_agent":"S3Console/0.4, aws-internal/3 aws-sdk-java/1.11.991 Linux/4.9.230-0.1.ac.224.84.332.metal1.x86_64 OpenJDK_64-Bit_Server_VM/25.282-b08 java/1.8.0_282 vendor/Oracle_Corporation cfg/retry-mode/legacy","version_id":"-","host_id":"JyPaquNlVOP38Ap/6E0zqnh5Zj75+9KAv0weFdQChcLd6oaNZZxWyJUPhQgahDu4EHWDy7zQOsA=","signature_version":"SigV4","cipher_suite":"ECDHE-RSA-AES128-GCM-SHA256","authentication_type":"AuthHeader","host_header":"wazuh-cloudtrail.s3.us-east-1.amazonaws.com","tls_version":"TLSv1.2","source":"s3_server_access"}}""",
            'json',
            '80361',
            3,
            id='aws_s3_delete_operation',
        ),
        pytest.param(
            r"""{"integration": "aws", "aws": {"log_info": {"aws_account_alias": "", "log_file": "access_logs/2021-04-29-09-41-37-6CFDED3B1BCCDEB1", "s3bucket": "wazuh-aws-wodle"}, "bucket_owner": "3ab1235e25ea9e94ff9b7e4e379ba6b0c872cd36c096e1ac8cce7df433b47101", "bucket": "wazuh-cloudtrail", "time": "29/Apr/2021:08:57:58 +0000", "remote_ip": "213.194.148.169", "requester": "arn:aws:iam::166157441623:user/carlos.ridao", "request_id": "M5XS2MGJ6FEA5VTJ", "operation": "REST.GET.BUCKETVERSIONS", "key": "-", "request_uri": "GET /?versions&max-keys=1&encoding-type=url HTTP/1.1", "http_status": "200", "error_code": "-", "bytes_sent": "839", "object_sent": "-", "total_time": "54", "turn_around_time": "53", "referer": "-", "user_agent": "S3Console/0.4, aws-internal/3 aws-sdk-java/1.11.991 Linux/4.9.230-0.1.ac.224.84.332.metal1.x86_64 OpenJDK_64-Bit_Server_VM/25.282-b08 java/1.8.0_282 vendor/Oracle_Corporation cfg/retry-mode/legacy", "version_id": "-", "host_id": "JyPaquNlVOP38Ap/6E0zqnh5Zj75+9KAv0weFdQChcLd6oaNZZxWyJUPhQgahDu4EHWDy7zQOsA=", "signature_version": "SigV4", "cipher_suite": "ECDHE-RSA-AES128-GCM-SHA256", "authentication_type": "AuthHeader", "host_header": "wazuh-cloudtrail.s3.us-east-1.amazonaws.com", "tls_version": "TLSv1.2", "source": "s3_server_access"}}""",
            'json',
            '80362',
            2,
            id='operation_get',
        ...
        pytest.param(
            r"""{"integration": "aws", "aws": {"log_info": {"aws_account_alias": "", "log_file": "access_logs/2021-04-29-09-41-37-6CFDED3B1BCCDEB1", "s3bucket": "wazuh-aws-wodle"}, "bucket_owner": "3ab1235e25ea9e94ff9b7e4e379ba6b0c872cd36c096e1ac8cce7df433b47101", "bucket": "wazuh-cloudtrail", "time": "29/Apr/2021:08:57:58 +0000", "remote_ip": "213.194.148.169", "requester": "arn:aws:iam::166157441623:user/carlos.ridao", "request_id": "M5XS2MGJ6FEA5VTJ", "operation": "REST.GET.OBJECT", "key": "-", "request_uri": "GET /?versions&max-keys=1&encoding-type=url HTTP/1.1", "http_status": "200", "error_code": "-", "bytes_sent": "839", "object_sent": "-", "total_time": "54", "turn_around_time": "53", "referer": "-", "user_agent": "S3Console/0.4, aws-internal/3 aws-sdk-java/1.11.991 Linux/4.9.230-0.1.ac.224.84.332.metal1.x86_64 OpenJDK_64-Bit_Server_VM/25.282-b08 java/1.8.0_282 vendor/Oracle_Corporation cfg/retry-mode/legacy", "version_id": "-", "host_id": "JyPaquNlVOP38Ap/6E0zqnh5Zj75+9KAv0weFdQChcLd6oaNZZxWyJUPhQgahDu4EHWDy7zQOsA=", "signature_version": "SigV4", "cipher_suite": "ECDHE-RSA-AES128-GCM-SHA256", "authentication_type": "AuthHeader", "host_header": "wazuh-cloudtrail.s3.us-east-1.amazonaws.com", "tls_version": "TLSv1.2", "source": "s3_server_access"}}""",
            'json',
            '80363',
            0,
            id='silence_general_rest_get_object',
        ),
        pytest.param(
            r"""{"integration": "aws", "aws": {"log_info": {"aws_account_alias": "", "log_file": "access_logs/2021-04-29-09-38-27-8196FC2529DE67C3", "s3bucket": "wazuh-aws-wodle"}, "bucket_owner": "3ab1235e25ea9e94ff9b7e4e379ba6b0c872cd36c096e1ac8cce7df433b47101", "bucket": "wazuh-cloudtrail", "time": "29/Apr/2021:08:52:31 +0000", "remote_ip": "-", "requester": "svc:cloudtrail.amazonaws.com", "request_id": "WF1XB03CFCAN420K", "operation": "REST.PUT.OBJECT", "key": "AWSLogs/166157441623/CloudTrail/us-west-1/2021/04/29/166157441623_CloudTrail_us-west-1_20210429T0840Z_QcTREycd1xiqQru5.json.gz", "request_uri": "PUT /AWSLogs/166157441623/CloudTrail/us-west-1/2021/04/29/166157441623_CloudTrail_us-west-1_20210429T0840Z_QcTREycd1xiqQru5.json.gz HTTP/1.1", "http_status": "200", "error_code": "-", "bytes_sent": "-", "object_sent": "2725", "total_time": "103", "turn_around_time": "15", "referer": "-", "user_agent": "-", "version_id": "-", "host_id": "FFcul1xzEVPZlAQn1tZoJq9SFEwudrfxAGWlYVbgM4OklyDqK8l9PNkSI30q17vwyGMUFQSyDGQ=", "signature_version": "SigV4", "cipher_suite": "ECDHE-RSA-AES128-GCM-SHA256", "authentication_type": "AuthHeader", "host_header": "wazuh-cloudtrail.s3.us-east-1.amazonaws.com", "tls_version": "TLSv1.2", "source": "s3_server_access"}}""",
            'json',
            '80364',
            3,
            id='operation_put',
        ...
        pytest.param(
            r"""{"integration":"aws","aws":{"log_info":{"aws_account_alias":"","log_file":"access_logs/2021-04-29-09-38-27-8196FC2529DE67C3","s3bucket":"wazuh-aws-wodle"},"bucket_owner":"3ab1235e25ea9e94ff9b7e4e379ba6b0c872cd36c096e1ac8cce7df433b47101","bucket":"wazuh-cloudtrail","time":"29/Apr/2021:08:52:31 +0000","remote_ip":"-","requester":"svc:s3.amazonaws.com","request_id":"WF1XB03CFCAN420K","operation":"REST.PUT.OBJECT","key":"AWSLogs/166157441623/CloudTrail/us-west-1/2021/04/29/166157441623_CloudTrail_us-west-1_20210429T0840Z_QcTREycd1xiqQru5.json.gz","request_uri":"PUT /AWSLogs/166157441623/CloudTrail/us-west-1/2021/04/29/166157441623_CloudTrail_us-west-1_20210429T0840Z_QcTREycd1xiqQru5.json.gz HTTP/1.1","http_status":"200","error_code":"-","bytes_sent":"-","object_sent":"2725","total_time":"103","turn_around_time":"15","referer":"-","user_agent":"-","version_id":"-","host_id":"FFcul1xzEVPZlAQn1tZoJq9SFEwudrfxAGWlYVbgM4OklyDqK8l9PNkSI30q17vwyGMUFQSyDGQ=","signature_version":"SigV4","cipher_suite":"ECDHE-RSA-AES128-GCM-SHA256","authentication_type":"AuthHeader","host_header":"wazuh-cloudtrail.s3.us-east-1.amazonaws.com","tls_version":"TLSv1.2","source":"s3_server_access"}}""",
            'json',
            '80365',
            0,
            id='silence_events_when_s3_puts',
        ),
        pytest.param(
            r"""{"integration":"aws","aws":{"log_info":{"aws_account_alias":"","log_file":"access_logs/2021-04-29-09-38-27-8196FC2529DE67C3","s3bucket":"wazuh-aws-wodle"},"bucket_owner":"3ab1235e25ea9e94ff9b7e4e379ba6b0c872cd36c096e1ac8cce7df433b47101","bucket":"wazuh-cloudtrail","time":"29/Apr/2021:08:52:31 +0000","remote_ip":"-","requester":"svc:cloudtrail.amazonaws.com","request_id":"WF1XB03CFCAN420K","operation":"REST.POST.OBJECT","key":"AWSLogs/166157441623/CloudTrail/us-west-1/2021/04/29/166157441623_CloudTrail_us-west-1_20210429T0840Z_QcTREycd1xiqQru5.json.gz","request_uri":"PUT /AWSLogs/166157441623/CloudTrail/us-west-1/2021/04/29/166157441623_CloudTrail_us-west-1_20210429T0840Z_QcTREycd1xiqQru5.json.gz HTTP/1.1","http_status":"200","error_code":"-","bytes_sent":"-","object_sent":"2725","total_time":"103","turn_around_time":"15","referer":"-","user_agent":"-","version_id":"-","host_id":"FFcul1xzEVPZlAQn1tZoJq9SFEwudrfxAGWlYVbgM4OklyDqK8l9PNkSI30q17vwyGMUFQSyDGQ=","signature_version":"SigV4","cipher_suite":"ECDHE-RSA-AES128-GCM-SHA256","authentication_type":"AuthHeader","host_header":"wazuh-cloudtrail.s3.us-east-1.amazonaws.com","tls_version":"TLSv1.2","source":"s3_server_access"}}""",
            'json',
            '80366',
            2,
            id='aws_s3_post_operation',
        ),
        pytest.param(
            r"""{"integration": "aws", "aws": {"log_info": {"aws_account_alias": "", "log_file": "access_logs/2021-04-29-09-47-05-689ED56B49777287", "s3bucket": "wazuh-aws-wodle"}, "bucket_owner": "3ab1235e25ea9e94ff9b7e4e379ba6b0c872cd36c096e1ac8cce7df433b47101", "bucket": "wazuh-cloudtrail", "time": "29/Apr/2021:08:47:53 +0000", "remote_ip": "92.57.74.50", "requester": "arn:aws:iam::166157441623:user/david.iglesias", "request_id": "T3BJ3QVNEB2XNQZ6", "operation": "REST.GET.ENCRYPTION", "key": "-", "request_uri": "GET /wazuh-cloudtrail?encryption= HTTP/1.1", "http_status": "404", "error_code": "ServerSideEncryptionConfigurationNotFoundError", "bytes_sent": "359", "object_sent": "-", "total_time": "28", "turn_around_time": "-", "referer": "-", "user_agent": "S3Console/0.4, aws-internal/3 aws-sdk-java/1.11.991 Linux/4.9.230-0.1.ac.224.84.332.metal1.x86_64 OpenJDK_64-Bit_Server_VM/25.282-b08 java/1.8.0_282 vendor/Oracle_Corporation cfg/retry-mode/legacy", "version_id": "-", "host_id": "aWts5+h5vGMYypTnH/uUuT+k1dt+C6r/qa9WqxHmYfv58SJlkEXi2EvgnOJcaIpTGs10FzFAS58=", "signature_version": "SigV4", "cipher_suite": "ECDHE-RSA-AES128-GCM-SHA256", "authentication_type": "AuthHeader", "host_header": "s3.amazonaws.com", "tls_version": "TLSv1.2", "source": "s3_server_access"}}""",
            'json',
            '80367',
            5,
            id='generic_error',
        ...
        pytest.param(
            ...
            '80370',
            5,
            id='aws_s3_authentication_failure',
        ),
    ],
)
def test_rule_match(
