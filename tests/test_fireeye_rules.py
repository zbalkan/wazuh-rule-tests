...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            r"""Sep  9 00:31:10 192.168.1.1 cef: CEF:0|FireEye|????|7.9.3.616878|MC|YYYY|7|rt=Sep 09 2017 00:31:23 UTC src=192.168.1.2 cn3La...=tcp dst=192.168.1.2 cs5Lab...""",
            'cef-fireeye',
            '150101',
            7,
            id='fireeye',
