...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            '81630',
            3,
            id='fortigate_attack_session_cleared',
        ),
        pytest.param(
        ...
        pytest.param(
            ...
            '81633',
            3,
            id='fortigate_6_app_passed_by_firewall',
        ),
        pytest.param(
