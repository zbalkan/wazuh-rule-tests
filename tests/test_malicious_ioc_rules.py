...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            'Dec 10 01:02:02 host sshd[1234]: Accepted none for root from 218.92.0.222 port 1066 ssh2',
            'sshd',
            '99903',
            14,
        ...
        pytest.param(
            'Dec 10 01:02:02 host sshd[1234]: Failed none for root from 218.92.0.222 port 1066 ssh2',
            'sshd',
            '99904',
            9,
        ...
        pytest.param(
            '[Thu May 12 16:02:18 2025] [error] [client 218.92.0.222] user nonexistentuser not found: /secure/login.php',
            'apache-errorlog',
            '99907',
            9,
        ...
        pytest.param(
            '[error] [client 218.92.0.222] File does not exist: /var/www/html/default.idasecure/login.php',
            'apache-errorlog',
            '99908',
            9,
        ...
        pytest.param(
            '2023-01-23 03:32:35.380619-0800  localhost screensharingd[3535]: Authentication: FAILED :: User Name: macos :: Viewer Address: 218.92.0.222 :: Type: DH',
        ...
        pytest.param(
            '2023-01-23 03:32:42.775333-0800  localhost screensharingd[3535]: Authentication: SUCCEEDED :: User Name: macos :: Viewer Address: 218.92.0.222 :: Type: N/A',
            'macOS_screensharingd',
            '99910',
            14,
        ...
        pytest.param(
            'Jan 11 03:42:09 hostname dovecot: auth-worker(default): sql(user@example.com,218.92.0.222): Password mismatch',
            'dovecot',
            '99911',
            9,
        ...
        pytest.param(
            "2017-04-03 15:55:24.37 Logon       Login succeeded for user 'DOMAIN\\user'. Connection made using Windows authentication. [CLIENT: 218.92.0.222]",
            'sqlserver',
            '99913',
            14,
        ...
        pytest.param(
            "2017-04-03 15:53:08.22 Logon       Login failed for user 'DOMAIN\\sqluser'. Reason: Failed to open the explicitly specified database. [CLIENT: 218.92.0.222]",
            'sqlserver',
            '99914',
            9,
        ...
        pytest.param(
            '{"timestamp":"2025-05-13T11:45:32.789012+0000","flow_id":1122334455667788,"in_iface":"eth0","event_type":"dns","src_ip":"192.168.1.101","src_port":33333,"dest_ip":"8.8.8.8","dest_port":53,"proto":"UDP","dns":{"type":"query","id":12345,"rrname":"qouv.fr","rrtype":"A","tx_id":1},"tx_id":1}',
            'json',
            '99918',
            9,
