...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            '99906',
            14,
            id='a_web_attack_from_malicious_ip_returned_code_200_success',
        ),
        pytest.param(
            r"""[Thu May 12 16:02:18 2025] [error] [client 218.92.0.222] user nonexistentuser not found: /secure/login.php""",
            'apache-errorlog',
            '99907',
            9,
            id='apache_user_authentication_from_malicious_ip_failed',
        ),
        pytest.param(
            r"""[error] [client 218.92.0.222] File does not exist: /var/www/html/default.idasecure/login.php""",
            'apache-errorlog',
            '99908',
            9,
            id='apache_attempt_to_access_forbidden_or_non_existent_file_or_directory_from_malicious_ip',
        ),
        pytest.param(
            r"""2023-01-23 03:32:35.380619-0800  localhost screensharingd[3535]: Authentication: FAILED :: User Name: macos :: Viewer Address: 218.92.0.222 :: Type: DH""",
            'macOS_screensharingd',
            '99909',
            9,
            id='attempt_to_connect_to_screen_sharing_with_username_from_malicious_ip_failed',
        ),
        pytest.param(
            r"""2023-01-23 03:32:42.775333-0800  localhost screensharingd[3535]: Authentication: SUCCEEDED :: User Name: macos :: Viewer Address: 218.92.0.222 :: Type: N/A""",
            'macOS_screensharingd',
            '99910',
            14,
            id='attempt_to_connect_to_screen_sharing_with_username_from_malicious_ip_succeeded',
        ),
        pytest.param(
            r"""Jan 11 03:42:09 hostname dovecot: auth-worker(default): sql(user@example.com,218.92.0.222): Password mismatch""",
            'dovecot',
            '99911',
            9,
            id='dovecot_authentication_from_malicious_ip_failed',
        ),
        pytest.param(
            r"""2017-04-03 15:55:24.37 Logon       Login succeeded for user 'DOMAIN\user'. Connection made using Windows authentication. [CLIENT: 218.92.0.222]""",
            'sqlserver',
            '99913',
            14,
            id='sql_server_login_from_malicious_ip_was_successful',
        ),
        pytest.param(
            r"""2017-04-03 15:53:08.22 Logon       Login failed for user 'DOMAIN\sqluser'. Reason: Failed to open the explicitly specified database. [CLIENT: 218.92.0.222]""",
            'sqlserver',
            '99914',
            9,
            id='sql_server_login_from_malicious_ip_failed',
        ),
        pytest.param(
            r"""{"timestamp":"2016-05-02T17:46:48.515262+0000","flow_id":1234,"in_iface":"eth0","event_type":"alert","src_ip":"218.92.0.222","src_port":5555,"dest_ip":"16.10.10.11","dest_port":80,"proto":"TCP","alert":{"action":"allowed","gid":1,"signature_id":2019236,"rev":3,"signature":"ET WEB_SERVER Possible CVE-2014-6271 Attempt in HTTP Version Number","category":"Attempted Administrator Privilege Gain","severity":1},"payload":"abcde","payload_printable":"hi test","stream":0,"host":"suricata.com"}""",
            'json',
            '99915',
            9,
            id='suricata_alert_from_malicious_ip_src_ip',
        ),
        pytest.param(
            ...
            '99916',
            9,
            id='suricata_alert_from_malicious_ip_dest_ip',
        ),
        pytest.param(
            r"""{"timestamp":"2025-05-13T10:23:45.123456+0000","flow_id":987654321098765,"in_iface":"eth0","event_type":"http","src_ip":"192.168.1.100","src_port":54321,"dest_ip":"93.184.216.34","dest_port":80,"proto":"TCP","http":{"hostname":"qouv.fr","url":"/index.html","http_user_agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64)","http_method":"GET","protocol":"HTTP/1.1","status":200,"length":1024},"tx_id":0}""",
            'json',
            '99917',
            9,
            id='suricata_alert_from_malicious_domain_http_hostname',
        ),
        pytest.param(
            r"""{"timestamp":"2025-05-13T11:45:32.789012+0000","flow_id":1122334455667788,"in_iface":"eth0","event_type":"dns","src_ip":"192.168.1.101","src_port":33333,"dest_ip":"8.8.8.8","dest_port":53,"proto":"UDP","dns":{"type":"query","id":12345,"rrname":"qouv.fr","rrtype":"A","tx_id":1},"tx_id":1}""",
            'json',
            '99918',
            9,
            id='suricata_alert_from_malicious_domain_dns_rrname',
        ),
        pytest.param(
