...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            r"""{"ts":1573747292.658982,"uid":"Crpk2p1rt6idRtb2Fi","id.orig_h":"10.0.2.2","id.orig_p":45398,"id.resp_h":"10.0.2.15","id.resp_p":22,"version":2,"auth_attempts":0,"client":"SSH-2.0-OpenSSH_7.9p1 Ubuntu-10","bro_engine":"SSH"}""",
            'json',
            '66001',
            5,
            id='ssh',
        ...
        pytest.param(
            r"""{"ts":1573804908.676001,"uid":"C4XJwR30xeMnOdUnm9","id.orig_h":"10.0.0.1","id.orig_p":56980,"id.resp_h":"10.0.0.5","id.resp_p":443,"resumed":false,"established":false,"bro_engine":"SSL"}""",
            'json',
            '66002',
            5,
            id='ssl',
