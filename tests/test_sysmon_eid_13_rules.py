...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            '92305',
            12,
            id='fodhelper_uac_bypass_evidence',
        ),
        pytest.param(
            ...
            '92306',
            12,
            id='powershell_adds_to_registry_uac_bypass_key',
        ),
        pytest.param(
            r"""{"win":{"eventdata":{"image":"C:\\\\Windows\\\\system32\\\\services.exe","targetObject":"HKLM\\\\System\\\\CurrentControlSet\\\\Services\\\\javamtsup\\\\ImagePath","processGuid":"{4dc16835-4447-6177-0b00-000000006b00}","processId":"636","utcTime":"2021-10-25 20:24:46.463","details":"C:\\\\Windows\\\\System32\\\\javamtsup.exe","eventType":"SetValue"},"system":{"eventID":"13","keywords":"0x8000000000000000","providerGuid":"{5770385f-c22a-43e0-bf4c-06f5698ffbd9}","level":"4","channel":"Microsoft-Windows-Sysmon/Operational","opcode":"0","message":"\"Registry value set:\r\nRuleName: -\r\nEventType: SetValue\r\nUtcTime: 2021-10-25 20:24:46.463\r\nProcessGuid: {4dc16835-4447-6177-0b00-000000006b00}\r\nProcessId: 636\r\nImage: C:\\Windows\\system32\\services.exe\r\nTargetObject: HKLM\\System\\CurrentControlSet\\Services\\javamtsup\\ImagePath\r\nDetails: C:\\Windows\\System32\\javamtsup.exe\"","version":"2","systemTime":"2021-10-25T20:24:46.4658681Z","eventRecordID":"409331","threadID":"3812","computer":"hrmanager.ExchangeTest.com","task":"13","processID":"2368","severityValue":"INFORMATION","providerName":"Microsoft-Windows-Sysmon"}}}""",
            'json',
            '92307',
            3,
            id='new_service_created_in_registry',
        ),
        pytest.param(
            r"""{"win":{"eventdata":{"image":"C:\\\\reg.exe","targetObject":"HKLM\\\\SOFTWARE\\\\CurrentControlSet\\\\Classes\\\\CLSID\\\\{B5F8350B-0548-48B1-A6EE-88BD00B4A5E8}\\\\LocalServer32","processGuid":"{4dc16835-c471-645e-0701-000000002000}","processId":"4140","utcTime":"2023-05-12 22:57:53.526","ruleName":"technique_id=T1543,technique_name=Service Creation","details":"C::\\\\windows\\\\calc.exe","eventType":"SetValue","user":"EXCHANGETEST\\\\AtomicRed"},"system":{"eventID":"13","keywords":"0x8000000000000000","providerGuid":"{5770385f-c22a-43e0-bf4c-06f5698ffbd9}","level":"4","channel":"Microsoft-Windows-Sysmon/Operational","opcode":"0","version":"2","systemTime":"2023-05-12T22:57:53.5273376Z","eventRecordID":"232330","threadID":"3064","computer":"cfo.ExchangeTest.com","task":"13","processID":"2156","severityValue":"INFORMATION","providerName":"Microsoft-Windows-Sysmon"}}}""",
            'json',
            '92308',
            3,
            id='possible_com_hijacking_evidence_found_in_registry',
        ),
        pytest.param(
            r"""{"win":{"eventdata":{"image":"C:\\\\reg.exe","targetObject":"HKLM\\\\SOFTWARE\\\\CurrentControlSet\\\\Classes\\\\CLSID\\\\{B5F8350B-0548-48B1-A6EE-88BD00B4A5E8}\\\\LocalServer32","processGuid":"{4dc16835-c471-645e-0701-000000002000}","processId":"4140","utcTime":"2023-05-12 22:57:53.526","ruleName":"technique_id=T1543,technique_name=Service Creation","details":"C::\\\\Users:\\\\AtomicRed:\\\\AppData:\\\\Local\\\\Temp\\\\calc.exe","eventType":"SetValue","user":"EXCHANGETEST\\\\AtomicRed"},"system":{"eventID":"13","keywords":"0x8000000000000000","providerGuid":"{5770385f-c22a-43e0-bf4c-06f5698ffbd9}","level":"4","channel":"Microsoft-Windows-Sysmon/Operational","opcode":"0","version":"2","systemTime":"2023-05-12T22:57:53.5273376Z","eventRecordID":"232330","threadID":"3064","computer":"cfo.ExchangeTest.com","task":"13","processID":"2156","severityValue":"INFORMATION","providerName":"Microsoft-Windows-Sysmon"}}}""",
            'json',
            '92309',
            15,
            id='com_hijacking_evidence_found_in_registry',
        ),
    ],
)
def test_rule_match(
