...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            '89502',
            14,
            id='wmiconsumerevent_created_possible_persistence_tactic_using_executables',
        ),
    ],
)
def test_rule_match(
