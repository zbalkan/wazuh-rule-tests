...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            '92157',
            6,
            id='executable_loaded_a_dll_from_temp_directory',
        ),
    ],
)
def test_rule_match(
