...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            '92400',
            12,
            id='possible_code_injection_on_explorer_exe',
        ),
        pytest.param(
            ...
            '92401',
            12,
            id='possible_code_injection_on_mstsc_exe',
        ),
        pytest.param(
            ...
            '92402',
            3,
            id='possible_code_injection_on_synchost_exe',
        ),
        pytest.param(
            ...
            '92403',
            12,
            id='possible_code_injection_on_lsass_exe_possible_credential_dumping',
        ),
    ],
)
def test_rule_match(
